                               ...
                               bool keepdim,cudaStream_t stream) //✨✨✨
{
    ...
    cuda_1926::reduce_kernel<CudaT, OutputCudaT, OpType><<<num_blocks, threads_per_block, shared_mem_size,stream>>>(
        input_data,
        output_data,
        d_input_dims.ptr,
        d_input_strides.ptr,
                                     ...
                                     bool keepdim,cudaStream_t stream) //✨✨✨
{
    ...
    cuda_1926::reduce_index_kernel<CudaT, OpType><<<num_blocks, threads_per_block, shared_mem_size,stream>>>(
        input_data,
        output_data,
        d_input_dims.ptr,
        d_input_strides.ptr,
                         ...
                         bool keepdim, cudaStream_t stream) //✨✨✨ 
{
    ...
    cuda_1926::reduce_mean_kernel<CudaT, OutputCudaT, SumOpType><<<num_blocks, threads_per_block, shared_mem_size,stream>>>(
        input_data,
        output_data,
        d_input_dims.ptr,
        d_input_strides.ptr,
...
Tensor dispatch_variance_gpu(const Tensor& input, 
    ...
    cuda_1926::reduce_variance_kernel<CudaT, MeanCudaT, OutputCudaT, VarianceOpType>
...
// ===========================================================
// int8_t (char) - Basic operations only
