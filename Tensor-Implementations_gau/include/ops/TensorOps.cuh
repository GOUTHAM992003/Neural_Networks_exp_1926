...
void cuda_mod_tensor(const Tensor& A, const Tensor& B, Tensor& output, cudaStream_t stream = 0);//✨✨✨
...
void cuda_mod_tensor_inplace( Tensor& A, const Tensor& B, cudaStream_t stream = 0);//✨✨✨
...
void cuda_logical_and_inplace(Tensor& A, const Tensor& B,cudaStream_t stream = 0);//✨✨✨
void cuda_logical_or_inplace(Tensor& A, const Tensor& B,cudaStream_t stream = 0);//✨✨✨
void cuda_logical_xor_inplace(Tensor& A,const Tensor& B,cudaStream_t stream =0);//✨✨✨
void cuda_logical_not_inplace(Tensor& A, cudaStream_t stream = 0);//✨✨✨
#endif
}